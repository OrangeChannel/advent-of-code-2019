...
phases, phases_b, signals_b = permutations(range(5)), permutations(range(5, 10)),[]
...
# Time (mean ± σ):      49.3 ms ±   0.4 ms    [User: 46.4 ms, System: 2.9 ms]
# Range (min … max):    48.8 ms …  51.3 ms    58 runs
